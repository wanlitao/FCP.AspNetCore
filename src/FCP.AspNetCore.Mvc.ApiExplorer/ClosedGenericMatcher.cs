...
namespace Microsoft.Extensions.Internal
{
    ...
    internal static class ClosedGenericMatcher
    {
        ...
        public static Type ExtractGenericInterface(Type queryType, Type interfaceType)
        {
            ...
            var matchInterfaceType = GetGenericInstantiation(queryType, interfaceType);
            if (matchInterfaceType != null)
            {
                return matchInterfaceType;
            }
            ...
            return ExtractGenericInterface(baseType, interfaceType);
